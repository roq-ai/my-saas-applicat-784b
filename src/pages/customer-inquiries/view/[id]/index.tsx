...
import { getCustomerInquiryById } from 'apiSdk/customer-inquiries';
...
function CustomerInquiryViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Customer Inquiry Detail View
          </Text>
          {hasAccess('customer_inquiry', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/customer-inquiries/edit/${data?.id}`} passHref legacyBehavior>
              <Button
