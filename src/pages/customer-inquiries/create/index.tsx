...
import { createCustomerInquiry } from 'apiSdk/customer-inquiries';
...
function CustomerInquiryCreatePage() {
  ...
  const handleSubmit = async (values: CustomerInquiryInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createCustomerInquiry(values);
      resetForm();
